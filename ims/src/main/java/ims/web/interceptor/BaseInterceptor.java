	...
	public void afterCompletion(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
		...
		if (null != exception) {
			...
			LogUtil.getLogger(LOG_TYPE.ERROR)
					.error("[" + DateUtil.formatDateTime(new Date()) + "]{"
							+ HttpUtils.getRemoteAddr(httpServletRequest) + "} 执行" + getClassMethod(object) + "["
							+ httpServletRequest.getMethod() + "]:" + ExceptionLogUtil.log(exception));
		}
